export default {
    ...
    steps: [
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>Stay up to date with notifications when there is a new SmartBAS version available, or updates to the nodes you have installed</p>`,
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>Flows exported from SmartBAS 4.1 now include information on what additional modules need to be installed.</p>
