...
var mani = {
    "name": "SmartBAS BMS Dashboard",
    "short_name": "SmartBAS",
    "description": "SmartBAS — Smart Building Automation Solutions",
    "start_url": "./#/0",
    "background_color": "#1a2412",
    "theme_color": "#1a2412",
    "display": "standalone",
    "icons": [
...
function addBaseConfig(config) {
    ...
    mani.name = config.site ? config.site.name : "SmartBAS BMS Dashboard";
    mani.short_name = mani.name.replace("Node-RED","SmartBAS").trim();
